...
function Cart() {
    ...
    const [produto, setProduto] = useState<Produto>({
        ...
        preco: 8.50,
        estoque: 10,
        foto: "https://www.paversul.com.br/wp-content/uploads/2019/03/o-que-vender-em-loja-de-produtos-naturais-facebook.jpg"
    })
    ...
    return (
        <>
            <Box m={2} display="flex" justifyContent="center">
                ...
                <Box display="flex" flexDirection="column" justifyContent="center" mb={1.5} className='box-buttons'>
